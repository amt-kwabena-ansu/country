...
function CountryPage() {
  ...
  return (
    <div className=' w-full bg-white bg-opacity-80  dark:bg-opacity-0'>
        <div className='min-h-screen flex flex-col flex-shrink-0 font-Nunito py-10 laptop:pt-0 laptop:mx-auto laptop:px-16 pc: gap-10 pc:min-w-[1020px] max-w-[1440px]'>
