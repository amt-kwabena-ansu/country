...
function Header() {
  ...
  return (
    <div className='   shadow-buttom'>
      <div  className='flex justify-items-stretch flex-shrink-0  font-Nunito px-4 pc:min-w-[1020px] laptop:max-w-[1440px] laptop:mx-auto laptop:px-16 py-5  bg-white text-darkText dark:bg-blue  dark:text-white'>
          ...
          <button key='themeChanger' className='flex gap-2' onClick={themeChanger}>
            <div key='theme-icon' className=' pt-1'>
              ...
              <svg key='theme-dark' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.8426 11.052C7.73486 11.052 5.21543 8.74226 5.21543 5.89457C5.21543 4.82024 5.57343 3.82526 6.18514 3C3.75229 3.75612 2 5.86498 2 8.35045C2 11.4708 4.75943 14 8.16286 14C10.8743 14 13.1757 12.3945 14 10.1636C13.1 10.7238 12.0129 11.052 10.8426 11.052Z" fill="white"  />
              </svg>
              ):(
